...
day4InvalidInputs: str = """eyr:1972 cid:100
...
day4ValidInputs: str = """pid:087499704 hgt:74in ecl:grn iyr:2012 eyr:2030 byr:1980
hcl:#623a2f
...
class TestDay4(unittest.TestCase):
    def test_pt1(self) -> None:
        for input, expected in [
            (testinputs.day4input, 2),
            (testinputs.day4valid, len(testinputs.day4valid)),
            (testinputs.day4invalid, len(testinputs.day4invalid))
        ]:
